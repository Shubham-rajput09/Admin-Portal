...
<template>
  <div class="black-bar">
    ...
    <!-- Vonage Icon -->
    <div>
      <img src="../../../assets/vonage-icon.jpg" alt="Notification Icon" class="notification-icon" />
    </div>
    <!--Help Button -->
    <button id="help">
    ...
    <button id="visitstore">
      <img src="../../../assets/visitstore.svg" alt="Visit Store" class="visit-store" />Visit Store
    </button>
  </div>
</template>
