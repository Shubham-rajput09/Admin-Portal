<template>
  <div class="background-container">
      ...
      <form @submit.prevent="handleSubmit" novalidate>
        ...
        <div class="input-row">
          ...
          <div class="input-group">
            ...
            <select id="employees" v-model="formData.employees" aria-label="Employees">
              ...
              <option v-for="(option, index) in employeeOptions" :key="index" :value="option">
                {{ option }}
              </option>
            </select>
          </div>
        ...
        <div class="input-row">
          ...
          <div class="input-group">
            ...
            <div class="phone-input">
              <select id="dialingCode" v-model="formData.countryCode" aria-label="Dialing Code" required>
                <option selected disabled value=""></option>
                <option v-for="(country, index) in countryData" :key="index" :value="country.value" :data-country-code="country.code" :data-country-name="country.name">
        ...
        <div class="input-row">
          <div class="input-group">
            ...
            >
              <option value="" disabled>Select</option>
              <option v-for="(interest, index) in interestOptions" :key="index" :value="interest">
                {{ interest }}
              </option>
            </select>
    ...
    <div class="thank-you-section" v-if="showThankYou">
      ...
      <p>
        We'll get back to you as soon as we can. In the meantime, feel free to explore
        more about Vonage and how we're making communications more flexible, intelligent,
        and personal so our customers can stay.
      </p>
...
export default {
  ...
  data() {
    return {
      ...
      countryOptions:[
        "Argentina", "Australia", "Austria", "Bangladesh", "Belgium", "Bhutan",
        "Brazil", "Canada", "China", "Czech Republic", "Denmark", "Egypt",
        "Finland", "France", "Germany", "Greece", "Hungary", "India",
        "Indonesia", "Ireland", "Israel", "Italy", "Japan", "Kazakhstan",
        "Kenya", "Malaysia", "Maldives", "Mexico", "Nepal", "Netherlands",
        "New Zealand", "Nigeria", "Norway", "Pakistan", "Philippines",
        "Poland", "Portugal", "Russia", "Saudi Arabia", "Scotland",
        "Singapore", "South Africa", "South Korea", "Spain", "Sri Lanka",
        "Sweden", "Switzerland", "Thailand", "Turkey", "UAE", "UK",
        "Ukraine", "USA", "Uzbekistan", "Vietnam", "Wales"
      ],
      showThankYou: false,
    };
  },
  methods: {
    ...
    validatePhoneNumber() {
      ...
      if (this.formData.phoneNumber && !phonePattern.test(this.formData.phoneNumber)) {
